...
def get_currency_input(currencies, currency_names):
    """
...
def fetch_supported_currencies():
    ...
    try:
        ...
        return result['symbols']  # Return dictionary of currency codes and their symbols
...
def main():
    ...
    """
    # Currency descriptions (some examples, you can expand this dictionary)
    currency_names = {
    ...
    init_currency, target_currency, amount = get_currency_input(currencies, currency_names)
